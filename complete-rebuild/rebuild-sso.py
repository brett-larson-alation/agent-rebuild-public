...
# 3. You must use SSO authentication and have pre-generated tokens.
#
...
# Note: User ID is not required - tokens are managed externally
#
...
with requests.Session() as session:
    try:
        ...
        logger.info("### Using SSO authentication tokens... ###")
